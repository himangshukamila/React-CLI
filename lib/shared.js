...
export const configureAxios = async (projectPath) => {
  await ensureDir(path.join(projectPath, 'src', 'services'))
...
export const webSocketContent = `const DEFAULT_URL = 'ws://localhost:3000'
...
class WebSocketClient {
  ...
  getWsUrl() {
    ...
    const raw = env.VITE_WS_URL || env.VITE_SERVER_URL || DEFAULT_URL
