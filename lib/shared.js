...
//     <!-- Enhanced glow effect for larger canvas -->
...
//   <!-- Outer Ambient Glow behind pillars -->
//   <circle cx="128" cy="128" r="80" fill="#22d3ee" opacity="0.08" filter="blur(20px)" />

//   <!-- Scaled Up Monolithic Pillars (4x scale) -->
//   <g stroke="#030712" stroke-width="6" stroke-linejoin="round">
//     <!-- Left Pillar -->
//     <polygon points="72,96 112,72 112,168 72,192" fill="url(#monoTop)" />
//     <!-- Middle Higher Pillar -->
//     <polygon points="112,72 152,48 152,144 112,168" fill="#67e8f9" />
//     <!-- Right Lower Pillar -->
//     <polygon points="152,112 192,88 192,184 152,208" fill="url(#monoSide)" />
//   </g>

//   <!-- Horizon Base Line -->
//   <line x1="56" y1="208" x2="200" y2="208" stroke="#22d3ee" stroke-opacity="0.35" stroke-width="4" stroke-dasharray="8 8" stroke-linecap="round" />
// </svg>
