...
export const commandReference = [
  ...
  ['react set api -get -post', 'Generate src/services/api.js with selected method flags (-get -post -put -delete -patch)'],
  ['react set ws', 'Generate production-grade WebSocket client service in src/services/webSocket.js'],
  ...
  ['react set button', 'Generate reusable Button component (src/components/Button.jsx) with variants & loading state'],
